...
const ChatView = () => {
    ...
    let getFriends = async () => {
        let response = await fetch('https://rshishir.pythonanywhere.com/api/patient/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + String(authTokens.access)
                        ...
                        <div className="chat-window">
                            {toggleChat ? (
                                <div className="chat-cont-left">
                                    ...
                                    <div className="chat-users-list chat-height">
                                                ...
                                                friends.map((friend) => {
                                                    return (
                                                        <a className="media read-chat" key={friend.id} onClick={() => {
                                                            ...
                                                            <Message messageList={messageList} friend={friend}/>
                                                        </a>
                                                    )
                                                })
                                            }
                                ...
                                <div className="chat-cont-right">
                                    <div className="chat-header">
                                        ...
                                        <div className="chat-options">
                                            <Link to={"/videochat"} state={{ room: room, friend: currentFriend }} data-toggle="modal" data-target="#video_call">
                                    ...
                                    <div className="chat-body chat-height">
